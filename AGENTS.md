...
- Color tokens: `--background: #0f0f0f`, `--card: #1a1a1a`, `--border: #2e2e2e`, `--foreground: #f5f5f5`, `--muted-foreground: #a1a1aa`, `--primary: #a855f7`, `--accent: #d946ef`, `--accent-rgb: #ffffff`
...
`about`, `contact`, `cta`, `footer`, `hero`, `home`, `nav`, `projects`, `services`, `stats`, `testimonials`
